...
<script src="<%=path%>/lib/bootstrap/js/bootstrap.min.js"></script>
  ...
  <body>
         ...
         %>
      <form method="get" action="com.College.process.UpdatePassWords">
      <div class="col-lg-3">
    密码  <input type="text" name="psd" value="<%=psd%>" class="form-control">
      </div>
      <div class="col-lg-3">
      学号<input type="text" name="sno" value="<%=sno%>" readonly="true"   class="form-control">
      </div>
      <br>
