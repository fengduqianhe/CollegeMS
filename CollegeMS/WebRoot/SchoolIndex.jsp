...
<base href="<%=basePath%>">
 <meta charset="utf-8"/>
<title>重庆文理学院</title>
<link rel="stylesheet" href="lib2/HomeCSS/layout.css" type="text/css" />
<!-- Homepage Specific Elements -->
<script type="text/javascript" src="lib2/scripts/jquery-1.4.1.min.js"></script>
<script type="text/javascript" src="lib2/scripts/jquery.easing.1.3.js"></script>
<script type="text/javascript" src="lib2/scripts/jquery.timers.1.2.js"></script>
<script type="text/javascript" src="lib2/scripts/jquery.galleryview.2.1.1.min.js"></script>
<script type="text/javascript" src="lib2/scripts/jquery.galleryview.setup.js"></script>
</head>
<body id="top">
...
<div class="wrapper row2">
    <div id="hpage_featured" class="clear">
        <div id="featured_slide">
            <ul>
                <li><img src="lib/image/1.jpg" alt="" />
                    <div class="panel-overlay">
                    </div>
                </li>
                <li><img src="lib/image/2.jpg" alt="" /></li>
                <li><img src="lib/image/3.jpg" alt="" />
                    <div class="panel-overlay">
                    </div>
                </li>
                <li><img src="lib/image/4.jpg" alt="" />
                    <div class="panel-overlay">
                    </div>
                </li>
            </ul>
